...
class Model():
    ...
    def __init__(self, log10masses = np.linspace(14, 15.5, num = 4), z_min = np.array([0., 0.25, 0.5, 0.75, 1.]), 
                 ...
                 theta_fiducial_mass_calibration = np.array([1.8, 0., 0.]),
    ...
    def compute_mass_calibration_params_array(self, cosmo_ccl, theta_mass_calibration, M_500, z):
        ...
        Y_star = 2.42e-10 # theta_mass_calibration[3]
        M_star = 1.0e14 # theta_mass_calibration[4]

        alpha_sigma = 0. # theta_mass_calibration[5]
        gamma_sigma = 0. # theta_mass_calibration[6]
        sigma_logY0 = 0.127 # theta_mass_calibration[7]
    ...
    def all_n_counts_trapz(self, z_min, z_max, Y_bins_limits, theta, theta_mass_calibration, 
        ...
        for i in range(n_bins_z):
            ...
            N_counts_temp = [self.compute_N_integral(M_500_integral_temp, factor, z_array) for M_500_integral_temp in M500_integral]
            #N_counts.append(N_counts_temp)
            N_counts = N_counts + N_counts_temp
